...
// We need these two for the l1tmhtemu::kStep and l1tmetemu::kStepPt definitions. 
// They need to be moved elsewhere, or the conversion made transparent for analyis 
// (this will end up being messy for HLT etc otherwise)
