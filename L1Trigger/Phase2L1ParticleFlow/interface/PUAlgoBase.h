...
namespace l1tpf_impl {
  ...
  public:
    ...
    virtual void doVertexings(std::vector<Region> &rs,
			      VertexAlgo algo,
    ...
    virtual void runNeutralsPU(Region &r, std::vector<float> &z0, float npu, const std::vector<float> &globals) const = 0;
