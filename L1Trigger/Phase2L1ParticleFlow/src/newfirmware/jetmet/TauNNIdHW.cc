...
#include "L1Trigger/Phase2L1ParticleFlow/src/newfirmware/jetmet/nnet_layer.h"
#include "L1Trigger/Phase2L1ParticleFlow/src/newfirmware/jetmet/nnet_activation.h"
...
result_t TauNNIdHW::compute(const l1t::PFCandidate &iSeed, std::vector<l1t::PFCandidate> &iParts) {
  ...
  std::sort(iParts.begin(), iParts.end(), [](l1t::PFCandidate i,l1t::PFCandidate j) { return (pt_t(i.pt()) > pt_t(j.pt())); });  
